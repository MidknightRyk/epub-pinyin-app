...
def translate_japanese_paragraphs(paragraphs, batch_size=20):
    translated_output = []

    try:
        print("Trying full chapter translation...")
        result = translator.translate(paragraphs, src='ja', dest='en')
        ...
        for i in range(0, len(paragraphs), batch_size):
            ...
            try:
                batch_result = translator.translate(batch, src='ja', dest='en')
